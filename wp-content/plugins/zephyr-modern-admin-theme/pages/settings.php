...
<div id="zephyr-admin-theme-settings" class="zephyr-wrap">
	...
	<form id="zat-settings-form" method="POST" class="zephyr-panel">
		...
		<label class="zat-label">Themes</label>
		<div id="zat-theme-palettes">

			<?php foreach ( $themes as $theme ) : ?>
				<?php $gradient_css = "background: " . $theme['gradient_end'] . ";
		    background: -moz-linear-gradient(-45deg, " . $theme['gradient_end'] . " 0%, " . $theme['gradient_start'] . " 100%);
		    background: -webkit-linear-gradient(-60deg, " . $theme['gradient_start'] . " 0%," . $theme['gradient_end'] . " 100%);
		    background: linear-gradient(135deg, " . $theme['gradient_end'] . " 0%," . $theme['gradient_start'] . " 100%);
		    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='" . $theme['gradient_start'] . "', endColorstr='" . $theme['gradient_start'] . "',GradientType=1 );"; ?>
		...
		<label class="zat-label"><?php _e( 'Primary Color', 'zephyr-admin-theme' );  ?></label>
		<input name="zat-primary-color" id="zpm-primary-color" class="zat-color-picker" value="<?php echo $settings['primary_color']; ?>" />

		<label class="zat-label"><?php _e( 'Secondary Color', 'zephyr-admin-theme' );  ?></label>
		<input name="zat-secondary-color" id="zpm-secondary-color" class="zat-color-picker" value="<?php echo $settings['secondary_color']; ?>" />

		<label class="zat-label"><?php _e( 'Main Background Color', 'zephyr-admin-theme' );  ?></label>
		<input name="zat-background-color" id="zpm-background-color" class="zat-color-picker" value="<?php echo $settings['background_color']; ?>" />

		<label class="zat-label"><?php _e( 'Gradient Start Color', 'zephyr-admin-theme' );  ?></label>
		<input name="zat-gradient-start-color" id="zpm-gradient-start" class="zat-color-picker" value="<?php echo $settings['gradient_start']; ?>" />

		<label class="zat-label"><?php _e( 'Gradient End Color', 'zephyr-admin-theme' );  ?></label>
		<input name="zat-gradient-end-color" id="zpm-gradient-end" class="zat-color-picker" value="<?php echo $settings['gradient_end']; ?>" />

		<label class="zat-label"><?php _e( 'Button Primary Color', 'zephyr-admin-theme' );  ?></label>
		<input name="zat-primary-button-color" id="zpm-button-primary" class="zat-color-picker" value="<?php echo $settings['button_primary']; ?>" />

		<label class="zat-label"><?php _e( 'Button Hover Color', 'zephyr-admin-theme' );  ?></label>
		<input name="zat-primary-button-hover-color" id="zpm-button-hover" class="zat-color-picker" value="<?php echo $settings['button_hover']; ?>" />

		<label class="zat-label"><?php _e( 'Menu Text Color', 'zephyr-admin-theme' );  ?></label>
		<input name="zat-text-color" id="zat-text-color" class="zat-color-picker" value="<?php echo $settings['text_color']; ?>" />

		<label class="zat-label"><?php _e( 'Select Font', 'zephyr-admin-theme' );  ?></label>
		...
		<div class="zat-form-section">
			<label class="zat-label"><?php _e( 'Theme Mode', 'zephyr-admin-theme' );  ?></label>
		...
		<label class="zat-label"><?php _e( 'Custom Login Redirect Page', 'zephyr-admin-theme' );  ?></label>
