...
<g>
	<g>
        ...
        <article>
            ...
            <p class='bs-as alpina'>Buenos<br/>Aires</p>
            <h2 class="alpina hover-italic" data-aos="fade-up" data-aos-duration="2000">La Llavi</h2>
            <p class='arg alpina'>Arg.<br/>1920</p>
        </article>
        <p class='v-crespo alpina'>Villa Crespo</p>
    </section>
<?php 
