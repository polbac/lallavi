...
<html>
	<head>
		...
		<title>LA LLAVI - <?php the_title(); ?></title>
		<link rel="stylesheet" href="/wp-content/themes/la-llavi/assets/js/lib/aos.css" />
		<link rel="stylesheet" href="https://unpkg.com/swiper@7/swiper-bundle.min.css" />
		<link rel="stylesheet" href="/wp-content/themes/la-llavi/assets/fonts/stylesheet.css" />
		<link rel="stylesheet" href="/wp-content/themes/la-llavi/style.css" />
	</head>

	<body class="<?php echo get_post_type();?> <?php echo isset($GLOBALS["THEME_CLASS"]) ? $GLOBALS["THEME_CLASS"] : '';?>">
	 ...
	 viewBox="0 0 298 294" style="enable-background:new 0 0 298 294;" xml:space="preserve">
		...
		<nav>
			...
			<div class="menu-items">
				<a href="/nosotrxs/nosotrxs">Nosotroxs</a>
